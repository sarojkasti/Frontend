...
const ProjectDetails = ({ project }: ProjectDetailsProps) => {
  ...
  return (
    <Card bodyStyle={{ padding: isMobile ? '12px 8px' : '24px' }}>
      <Descriptions 
        bordered 
        column={isMobile ? 1 : 2}
        size={isMobile ? "small" : "default"}
      >
        <Descriptions.Item label="Project Name" span={isMobile ? 1 : 2}>
        ...
        <Descriptions.Item label="Fiscal Year">
          {project.fiscalYear}/{(Number(project.fiscalYear) + 1).toString().slice(-2)}
        </Descriptions.Item>
        ...
        <Descriptions.Item label="Client" span={isMobile ? 1 : 2}>
          {(project as any).customer?.name || 'N/A'}
        </Descriptions.Item>
        <Descriptions.Item label="Billing Entity" span={isMobile ? 1 : 2}>
          ...
          <Card
            ...
            title={
              <Space>
                ...
                <span className="text-sm sm:text-base">Client Payment & Document Access</span>
              </Space>
            }
            type="inner"
          >
